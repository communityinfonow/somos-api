...
public class CensusTractPhotoLinks {
    ...
    public Link photoFile(Integer tractId, String fileName, Boolean self) {
        return this.connectedLinks.configureRelation(linkTo(ReflectionUtils.findMethod(CensusTractPhotoController.class,
                "getPhotoFile", Integer.class, String.class), tractId, fileName), self, "photo-file");
    }

    public Link photo(Integer tractId, Long photoId, Boolean self) {
        return this.connectedLinks.configureRelation(
                linkTo(methodOn(CensusTractPhotoController.class).getPhoto(tractId, photoId)), self, "photo");
    }
